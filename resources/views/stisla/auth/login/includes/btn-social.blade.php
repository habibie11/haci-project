{{-- @dd($_is_login_with_google, $_is_login_with_facebook, $_is_login_with_twitter, $_is_login_with_github) --}}
...
<div class="row">
  <div class="col-md-12" align="center">
    ...
    <a href="{{ route('social-login', ['google']) }}" class="btn btn-social-icon btn-facebook mr-1"
...
{{-- <div class="row">
  @if ($_is_login_with_google)
  <div class="col-md-6">
    <a class="btn btn-block btn-social btn-facebook" style="background-color: rgba(220,20,20,1)"
