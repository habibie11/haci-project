...
<div class="section-body">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive" id="datatable-view">
            ...
            <textarea name="yajraColumns" id="yajraColumns" cols="30" rows="10"
              style="display: none;">{!! $yajraColumns !!}</textarea>
            @endif
            @yield('table')
          </div>
        </div>
      ...
      @else
      @include('stisla.includes.others.empty-state', ['title' => 'Data ' . $title, 'icon' => $moduleIcon, 'link' =>
      $route_create])
      @endif
    </div>
