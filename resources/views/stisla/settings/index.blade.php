    ...
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <br />
          <div class="row">
            @foreach (['_logo_url' => __('Logo'), '_stisla_bg_login' => __('Background Halaman Masuk / Daftar'),
            '_stisla_bg_home' => __('Background Halaman Beranda')] as $item => $labelSetting)
      ...
      'https://developers.facebook.com/apps/?show_reminder=true', 'https://developer.twitter.com/en/portal/dashboard',
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('settings.update', ['provider' => $provider]) }}" method="POST"
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-12">
                Dashboard untuk mendapatkan client id dan secret bisa mengakses <a target="_blank"
                  href="{{ $url[$i] ?? '#' }}">{{ $url[$i] ?? '#' }}</a>
                <br>
                <br>
              </div>
